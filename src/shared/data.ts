import { SurfaceFamily, SKUReference, FRU, ScrapedData } from './types';
import scrapedJson from './scraped-data.json';

// Live data scraped monthly from Microsoft Learn service guides.
// Regenerated by scripts/generate_app_data.py during the GitHub Actions
// monthly-update workflow. Safe to import at build time — falls back to an
// empty dataset on first run before any scrape has populated the file.
export const SCRAPED_DATA: ScrapedData = scrapedJson as ScrapedData;
